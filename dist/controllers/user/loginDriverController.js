...
const LoginDriverController = (0, catchAsync_1.default)(async (req, res) => {
    const { email, password } = req.body;
    try {
        // Check if the user exists
        const user = await server_1.prisma.user.findFirst({ where: { OR: [{ email }] } });
        if (!user) {
...
exports.default = LoginDriverController;
//# sourceMappingURL=loginDriverController.js.map